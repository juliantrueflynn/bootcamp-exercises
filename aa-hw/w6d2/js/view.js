...
View.prototype.exercise4 = function () {
  ...
  // From solutions, much better than mine above.
  $('li.square:nth-child(even)').text("JTF");
};
...
View.prototype.exercise6 = function () {
  ...
  for (let i = 0; i < li.length; i++) {
    $(li[i]).attr('style', 'background-color:' + window._randomColorString());  
  }
};
...
View.prototype.exercise7 = function(){
  ...
  const li = $('li.square');
  // for (let i = 0; i < li.length; i++) {
  //   $('ul.row').on('hover', $(li[i]), function (e) {
  //     console.log(e);
  //     console.log($(e.currentTarget).attr('style'));
  //   });
  // }
